...
{
    static partial class TextParser
    {
        internal class Exception : System.Exception
        {
            public Exception(int index)
                : base("invalid character")
            {
                this.Index = index;
            }
            public Exception(int index, string message)
                : base(message)
            {
                this.Index = index;
            }
            public Exception(int index, string message, System.Exception innerException)
